...
import { PLAYER_COUNTS } from "@/games/kuhle-kuehe/settings/app-settings";
import {
 ...
 */
export function KuhleKueheSettingsView(): ReactElement {
        ...
        >
          {PLAYER_COUNTS.map((count) => (
            <button
              ...
              data-testid={`kuhle-kuehe-players-${count}`}
