/**
 * The Kuhle Kühe settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: KuhleKueheSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): KuhleKueheSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): KuhleKueheSettings {
 ...
 */
export function updateSettings(settings: KuhleKueheSettings): void {
