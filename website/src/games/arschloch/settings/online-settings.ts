 ...
 */
import { MIN_PLAYERS } from "@/games/arschloch/engine/state";
...
const COUNT_KEY = storageKey("arschloch", "online-player-count");
...
function onlineCount(value: unknown): number {
  return Math.max(MIN_PLAYERS, clampPlayers(value));
}
