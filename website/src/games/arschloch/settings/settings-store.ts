/**
 * Arschloch settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: ArschlochSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): ArschlochSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): ArschlochSettings {
 ...
 */
export function updateSettings(settings: ArschlochSettings): void {
