/**
 * The Bohnanza settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: BohnanzaSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): BohnanzaSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): BohnanzaSettings {
 ...
 */
export function updateSettings(settings: BohnanzaSettings): void {
