/**
 * Bohnanza settings: how many sit at the table.
 *
 * @module
 */
"use client";
...
import { PLAYER_COUNTS } from "@/games/bohnanza/settings/app-settings";
import {
 ...
 */
export function BohnanzaSettingsView(): ReactElement {
        ...
        >
          {PLAYER_COUNTS.map((count) => (
            <button
              ...
              data-testid={`bohnanza-players-${count}`}
