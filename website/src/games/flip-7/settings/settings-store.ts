/**
 * The Flip 7 settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: Flip7Settings | null = null;
 ...
 */
export function getSettingsSnapshot(): Flip7Settings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): Flip7Settings {
 ...
 */
export function updateSettings(settings: Flip7Settings): void {
