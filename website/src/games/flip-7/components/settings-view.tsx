/**
 * Flip 7 settings: how many sit at the table.
 *
 * @module
 */
"use client";
...
import { PLAYER_COUNTS } from "@/games/flip-7/settings/app-settings";
import {
 ...
 */
export function Flip7SettingsView(): ReactElement {
        ...
        >
          {PLAYER_COUNTS.map((count) => (
            <button
              ...
              data-testid={`flip-7-players-${count}`}
