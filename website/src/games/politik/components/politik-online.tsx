/**
 * "Das politische Talent" online: the entry screen, the lobby and the table.
 *
 * @module
 * @remarks
...
import {
  politikAdapter,
  type PolitikOptions,
} from "@/games/politik/multiplayer/adapter";
import {
  DEFAULT_PLAYER_COUNT,
  PLAYER_COUNTS,
} from "@/games/politik/settings/app-settings";
import {
  loadMatchCount,
  saveMatchCount,
} from "@/games/politik/settings/online-settings";
...
const L = {
  ...
  subtitle: "Ein Parlament, jede Partei am eigenen Gerät",
  back: "Zurück",
  yourName: "Dein Name",
...
const GAME_ID = politikAdapter.gameId;
 ...
 */
export function PolitikOnlineScreen(): ReactElement {
  ...
  const room = useOnlineRoom(politikAdapter, session);
...
type Room = OnlineRoom<PolitikGame, PolitikMove, PolitikOptions>;
