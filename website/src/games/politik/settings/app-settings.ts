/**
 * Settings of "Das politische Talent", stored in the browser.
 *
 * @module
 * @remarks
 ...
 */
import { MAX_PLAYERS, MIN_PLAYERS } from "@/games/politik/engine/state";
...
const SETTINGS_KEY = storageKey("politik", "settings");
...
export type PolitikSettings = {
  /** How many parties sit at the table, the human included. */
  readonly playerCount: number;
};

/** What a first-time visitor gets. */
export const DEFAULT_SETTINGS: PolitikSettings = {
 ...
 */
export function loadSettings(): PolitikSettings {
 ...
 */
export function saveSettings(settings: PolitikSettings): void {
...
function isPartialSettings(value: unknown): value is Partial<PolitikSettings> {
