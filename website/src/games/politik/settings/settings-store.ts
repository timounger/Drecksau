...
let cache: PolitikSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): PolitikSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): PolitikSettings {
 ...
 */
export function updateSettings(settings: PolitikSettings): void {
