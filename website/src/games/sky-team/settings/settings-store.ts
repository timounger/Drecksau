/**
 * The Sky Team settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: SkyTeamSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): SkyTeamSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): SkyTeamSettings {
 ...
 */
export function updateSettings(settings: SkyTeamSettings): void {
