/**
 * The Flash Point settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: FlashPointSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): FlashPointSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): FlashPointSettings {
 ...
 */
export function updateSettings(settings: FlashPointSettings): void {
