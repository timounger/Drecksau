...
export const SKYJO_TEXTS = {
  ...
  rules: [
    ...
    "Im Zug nimmst du entweder die offene Karte vom Ablagestapel oder ziehst verdeckt.",
    "Die genommene Karte tauschst du gegen eine deiner Karten - die alte kommt offen auf den Ablagestapel.",
    "Eine verdeckt gezogene Karte darfst du auch wegwerfen und stattdessen eine eigene Karte aufdecken.",
  ...
  chooseSource: "Nimm die offene Karte oder zieh verdeckt.",
  takeDiscard: "Offene Karte nehmen",
  drawCard: "Verdeckt ziehen",
  placeHint: "Wähle die Karte, die du ersetzen willst.",
  drawnHint: "Tauschen oder wegwerfen und dafür aufdecken.",
  swapDrawn: "Tauschen",
  throwAway: "Wegwerfen & aufdecken",
  flipHint: "Wähle eine verdeckte Karte zum Aufdecken.",
  cancel: "Abbrechen",
  deck: "Nachziehstapel",
