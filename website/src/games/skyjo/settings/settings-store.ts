/**
 * The Skyjo settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: SkyjoSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): SkyjoSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): SkyjoSettings {
 ...
 */
export function updateSettings(settings: SkyjoSettings): void {
