/**
 * Dog settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: DogSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): DogSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): DogSettings {
 ...
 */
export function updateSettings(settings: DogSettings): void {
