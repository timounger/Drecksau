/**
 * Remembers the name a player last used for online Panzerkiste, so the entry
 * screen can prefill it next time.
 *
 * @module
 * @remarks
 * Stored per browser under a Panzerkiste-specific key, separate from the other
 * games' names.
 */
...
const NAME_KEY = storageKey("panzerkiste", "online-player-name");
