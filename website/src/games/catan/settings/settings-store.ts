/**
 * CATAN settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: CatanSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): CatanSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): CatanSettings {
 ...
 */
export function updateSettings(settings: CatanSettings): void {
