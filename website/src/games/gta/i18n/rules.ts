  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Auf dem Militärgelände steht außerdem der Black Hawk, den man fliegen kann: E steigt ein, Leertaste steigt, W fliegt. Er ist bewaffnet wie der Panzer und wird genauso bedient - linke Maustaste feuert eine Rakete, die rechte hält das Maschinengewehr am Laufen, und beides geht dorthin, wohin die Maschine zeigt. Rings um den Zaun stehen vier Luftabwehrstellungen, die auf alles schießen, was dort in der Luft ist.",
        ...
        "Der Flughafen zieht sich unterhalb des Gefängnisses quer bis an den östlichen Kartenrand. Er ist eingezäunt und hat genau ein Tor, am westlichen Ende an der Straße. Auf dem Vorfeld stehen drei Flugzeuge, in die du einsteigen kannst wie in einen Hubschrauber - nur heben sie nicht auf der Stelle ab: Erst Fahrt aufnehmen, und zwar auf der Landebahn, dann zieht die Leertaste hoch. Mit S rollt die Maschine rückwärts, aber nur im Schritttempo - zum Rangieren, nicht zum Fahren. Aussteigen geht erst, wenn die Maschine steht. Im Flug zeigt die Ecke oben rechts die Maschine und ihr Blech statt deiner Waffe - Treffer von unten kosten das Flugzeug, nicht dich. Ist das Blech leer, sinkt sie und schlägt auf.",
    ...
    },
    {
      ...
      body: [
        "Du fängst mit der Faust an. Messer, Pistole, Maschinengewehr, Flammenwerfer, Panzerfaust und Granaten liegen in der Stadt herum - wer sie will, muss laufen. Aufgenommenes kommt nach einer Weile an derselben Stelle zurück. Der Flammenwerfer setzt außerdem den Boden in Brand: Wo du hingesprüht hast, brennt es noch ein paar Sekunden weiter, und wer darin steht, nimmt weiter Schaden - du selbst auch.",
