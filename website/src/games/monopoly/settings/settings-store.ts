/**
 * Monopoly settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: MonopolySettings | null = null;
 ...
 */
export function getSettingsSnapshot(): MonopolySettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): MonopolySettings {
 ...
 */
export function updateSettings(settings: MonopolySettings): void {
