...
const COUNT_KEY = storageKey("monopoly", "online-player-count");
 ...
 *
 * @remarks
 * The same two to six the box seats: Monopoly needs no special arrangement for
 * a small table, so this is the shared clamp and nothing else.
 */
