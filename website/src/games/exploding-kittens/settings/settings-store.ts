/**
 * The Exploding Kittens settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: ExplodingKittensSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): ExplodingKittensSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): ExplodingKittensSettings {
 ...
 */
export function updateSettings(settings: ExplodingKittensSettings): void {
