/**
 * The seeded generator the deck is shuffled from.
 *
 * @module
 * @remarks
 * The same generator the other games of the collection use, with its cursor
 * carried **inside** the game state. Every level is a fresh deal from the same
 * sequence, so a saved game and a snapshot on the wire both have to remember
 * where that sequence had got to.
 */
