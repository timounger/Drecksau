...
import {
  theMindAdapter,
  type MindOptions,
} from "@/games/the-mind/multiplayer/adapter";
import {
  DEFAULT_PLAYER_COUNT,
  PLAYER_COUNTS,
} from "@/games/the-mind/settings/app-settings";
import {
  loadMatchCount,
  saveMatchCount,
...
const GAME_ID = theMindAdapter.gameId;
 ...
 */
export function TheMindOnlineScreen(): ReactElement {
  ...
  const room = useOnlineRoom(theMindAdapter, session);
...
type Room = OnlineRoom<MindGame, MindMove, MindOptions>;
