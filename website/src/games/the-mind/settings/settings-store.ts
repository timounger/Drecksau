/**
 * The The Mind settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: MindSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): MindSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): MindSettings {
 ...
 */
export function updateSettings(settings: MindSettings): void {
