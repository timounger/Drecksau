/**
 * Qwixx settings, stored in the browser.
 *
 * @module
 * @remarks
 ...
 */
import { MAX_PLAYERS, MIN_PLAYERS } from "@/games/qwixx/engine/state";
...
const SETTINGS_KEY = storageKey("qwixx", "settings");
...
export type QwixxSettings = {
  /** How many roll, the human included. */
  readonly playerCount: number;
};

/** What a first-time visitor gets. */
export const DEFAULT_SETTINGS: QwixxSettings = {
 ...
 */
export function loadSettings(): QwixxSettings {
 ...
 */
export function saveSettings(settings: QwixxSettings): void {
...
function isPartialSettings(value: unknown): value is Partial<QwixxSettings> {
