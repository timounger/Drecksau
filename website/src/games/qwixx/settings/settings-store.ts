/**
 * The Qwixx settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: QwixxSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): QwixxSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): QwixxSettings {
 ...
 */
export function updateSettings(settings: QwixxSettings): void {
