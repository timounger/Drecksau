 ...
 *
 * @remarks
 * See `docs/games/drecksau/game-rules.md` for the effect of each card.
 */
 ...
 *
 * @remarks
 * Both are defence cards that trigger automatically - see `docs/games/drecksau/game-rules.md`.
