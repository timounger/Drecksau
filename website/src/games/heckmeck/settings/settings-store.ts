/**
 * The Heckmeck settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: HeckmeckSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): HeckmeckSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): HeckmeckSettings {
 ...
 */
export function updateSettings(settings: HeckmeckSettings): void {
