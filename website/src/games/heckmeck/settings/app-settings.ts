/**
 * Heckmeck settings, stored in the browser.
 *
 * @module
 * @remarks
 ...
 */
import { MAX_PLAYERS, MIN_PLAYERS } from "@/games/heckmeck/engine/state";
...
const SETTINGS_KEY = storageKey("heckmeck", "settings");
...
export type HeckmeckSettings = {
  /** How many roll for worms, the human included. */
  readonly playerCount: number;
};

/** What a first-time visitor gets. */
export const DEFAULT_SETTINGS: HeckmeckSettings = {
 ...
 */
export function loadSettings(): HeckmeckSettings {
 ...
 */
export function saveSettings(settings: HeckmeckSettings): void {
...
function isPartialSettings(value: unknown): value is Partial<HeckmeckSettings> {
