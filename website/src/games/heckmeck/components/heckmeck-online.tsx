/**
 * Qwixx online: the entry screen, the lobby and the table.
 *
 * @module
 * @remarks
...
import {
  heckmeckAdapter,
  type HeckmeckOptions,
} from "@/games/heckmeck/multiplayer/adapter";
import {
  DEFAULT_PLAYER_COUNT,
  PLAYER_COUNTS,
} from "@/games/heckmeck/settings/app-settings";
import {
  loadMatchCount,
  saveMatchCount,
} from "@/games/heckmeck/settings/online-settings";
...
const GAME_ID = heckmeckAdapter.gameId;
 ...
 */
export function HeckmeckOnlineScreen(): ReactElement {
  ...
  const room = useOnlineRoom(heckmeckAdapter, session);
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-4 p-4">
      <header className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <RulesButton rules={HECKMECK_RULES} />
          <Link
            href="/heckmeck"
...
type Room = OnlineRoom<HeckmeckGame, HeckmeckMove, HeckmeckOptions>;
...
function Playing({
  ...
  const remainingMs = useTurnClock({
    ...
    turn: room.room === null ? "" : turnKeyOf(room.room, heckmeckAdapter),
