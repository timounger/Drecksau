...
import {
  kniffelAdapter,
  type KniffelOptions,
} from "@/games/kniffel/multiplayer/adapter";
import {
  DEFAULT_PLAYER_COUNT,
  ONLINE_PLAYER_COUNTS,
} from "@/games/kniffel/settings/app-settings";
import {
  loadMatchCount,
  saveMatchCount,
} from "@/games/kniffel/settings/online-settings";
...
const L = {
  ...
  subtitle: "Ein Block je Person - jede:r am eigenen Gerät",
  back: "Zurück",
  yourName: "Dein Name",
...
const GAME_ID = kniffelAdapter.gameId;
 ...
 */
export function KniffelOnlineScreen(): ReactElement {
  ...
  const room = useOnlineRoom(kniffelAdapter, session);
...
type Room = OnlineRoom<KniffelGame, KniffelMove, KniffelOptions>;
...
function PlayerCountPicker({
  ...
  return (
    ...
    >
      ...
      {ONLINE_PLAYER_COUNTS.map((option) => (
        <button
          key={option}
          type="button"
          role="radio"
