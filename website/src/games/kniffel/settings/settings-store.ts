/**
 * The Kniffel settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: KniffelSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): KniffelSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): KniffelSettings {
 ...
 */
export function updateSettings(settings: KniffelSettings): void {
