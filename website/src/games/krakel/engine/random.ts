 ...
 * @module
 * @remarks
 * Used to pick the round's term and to draw the base "Krakel" squiggle. Being
 * seeded, every client that is handed the same seed produces the exact same
 * word and squiggle without any of it crossing the wire. This is the well-known
 * mulberry32 generator - small, fast and good enough for picking words and
 * jittering a line.
 */
