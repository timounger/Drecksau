/**
 * Remembers the name a player last used for online Krakel Orakel, so the entry
 * screen can prefill it next time.
 *
 * @module
 * @remarks
 * Stored per browser under a Krakel-specific key, separate from the other
 * games' names.
 */
...
const NAME_KEY = storageKey("krakel", "online-player-name");
