/**
 * Jammerlappen settings: how many sit at the table.
 *
 * @module
 */
"use client";
...
import { PLAYER_COUNTS } from "@/games/jammerlappen/settings/app-settings";
import {
 ...
 */
export function JammerlappenSettingsView(): ReactElement {
        ...
        >
          {PLAYER_COUNTS.map((count) => (
            <button
              ...
              data-testid={`jammerlappen-players-${count}`}
