/**
 * The Jammerlappen settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: JammerlappenSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): JammerlappenSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): JammerlappenSettings {
 ...
 */
export function updateSettings(settings: JammerlappenSettings): void {
