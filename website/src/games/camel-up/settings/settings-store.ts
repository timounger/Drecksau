/**
 * The Camel Up settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: CamelUpSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): CamelUpSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): CamelUpSettings {
 ...
 */
export function updateSettings(settings: CamelUpSettings): void {
