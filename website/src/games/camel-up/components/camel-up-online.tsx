/**
 * Camel Up online: the entry screen, the lobby and the table.
 *
 * @module
 * @remarks
...
import {
  camelUpAdapter,
  type CamelUpOptions,
} from "@/games/camel-up/multiplayer/adapter";
import {
  DEFAULT_PLAYER_COUNT,
  PLAYER_COUNTS,
} from "@/games/camel-up/settings/app-settings";
import {
  loadMatchCount,
  saveMatchCount,
} from "@/games/camel-up/settings/online-settings";
...
const L = {
  ...
  subtitle: "Ein Rennen, jede:r am eigenen Gerät",
  back: "Zurück",
  yourName: "Dein Name",
...
const GAME_ID = camelUpAdapter.gameId;
 ...
 */
export function CamelUpOnlineScreen(): ReactElement {
  ...
  const room = useOnlineRoom(camelUpAdapter, session);
...
type Room = OnlineRoom<CamelUpGame, CamelUpMove, CamelUpOptions>;
