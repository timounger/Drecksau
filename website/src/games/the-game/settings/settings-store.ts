/**
 * The Game settings as an external store React can subscribe to.
 *
 * @module
 * @remarks
...
let cache: TheGameSettings | null = null;
 ...
 */
export function getSettingsSnapshot(): TheGameSettings {
  if (cache === null) {
    cache = loadSettings();
  }
  return cache;
 ...
 */
export function getServerSettingsSnapshot(): TheGameSettings {
 ...
 */
export function updateSettings(settings: TheGameSettings): void {
